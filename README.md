...
그래서 저희는 타인의 시선을 통해 개인의 긍정적인 행동을 증가시킨다는 **사회촉진이론**을 근거로 `스마트폰 & 숏폼 중독 방지를 위한 재밌는 스마트폰 사용 시간, 앱 관리 어플리케이션 "TTAK"`을 기획하게 되었습니다.
...
- Client: Android 11
- Back-end: JDK 21, SpringBoot 3.3.2, MySQL 8.3.0
- Infra: Nginx, AWS EC2, AWS S3, Docker, Elasticsearch, Logstash, Kibana
...
| 이름                                       | 구분 | 역할           | 수행업무                                                         |
| ------------------------------------------ | ---- | -------------- | ---------------------------------------------------------------- |
| [황정현](https://github.com/roccoIi)       | 팀장 | BE             |                                      |
| [송예진](https://github.com/songsongyejin) | 팀원 | BE             |               |
| [이치왕](https://github.com/noxknow)       | 팀원 | Infra, Android |               |
| [김명화](https://github.com/monghwadang)   | 팀원 | Android        |               |
| [원민혁](https://github.com/wmy4534)       | 팀원 | Android        | |
| [이규석](https://github.com/qldrh112)      | 팀원 | Android        ||
